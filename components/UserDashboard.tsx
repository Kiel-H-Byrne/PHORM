...
import { FaBuilding, FaHeart, FaMapMarkerAlt, FaPlus, FaUser } from 'react-icons/fa';
        ...
        >
          ...
          >
            <Stat px={2}>
              ...
              <StatNumber>{isLoading ? <Skeleton height="1.5rem" width="3rem" mx="auto" /> : userListings.length}</StatNumber>
            </Stat>
            <Stat px={2}>
              <StatLabel>Favorites</StatLabel>
              <StatNumber>{isLoading ? <Skeleton height="1.5rem" width="3rem" mx="auto" /> : favoriteListings.length}</StatNumber>
            </Stat>
          </StatGroup>
        </Flex>
      </Box>
            ...
            <TabPanel>
              {isLoading ? (
                ...
                <Box textAlign="center" py={10}>
                  ...
                  <Heading size="md" mb={2}>No Listings Yet</Heading>
                  <Text color="gray.500" mb={6}>You haven't added any business listings yet.</Text>
                  <Button 
                    colorScheme="blue" 
                    leftIcon={<Icon as={FaPlus} />}
                    onClick={handleAddListing}
            ...
            <TabPanel>
              {isLoading ? (
                ...
                <Box textAlign="center" py={10}>
                  ...
                  <Text color="gray.500" mb={6}>You haven't saved any favorite businesses yet.</Text>
                  <Button 
                    colorScheme="blue" 
                    onClick={() => router.push('/')}
                  >
